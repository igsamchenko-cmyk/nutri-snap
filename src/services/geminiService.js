...
export async function searchSmartProducts(query, apiKey, modelName = 'gemini-2.5-flash') {
  ...
  const promptText = `
    ...
    Якщо запит стосується загальних продуктів (наприклад, "яблуко", "куряче філе", "вівсянка") або домашніх страв ("борщ", "пюре"):
    - Надай 2-4 варіанти: базовий (сирий/свіжий продукт), варений/запечений, або популярні варіації приготування.
    ...
    Поверни від 2 до 5 найбільш релевантних продуктів.
    ...
    - "name": Повна назва продукту з назвою бренду або типу приготування
    ...
    - "fat": Жири на 100г в грамах (число, округлене до 1 знака)
    - "carbs": Вуглеводи на 100г в грамах (число, округлене до 1 знака)
    - "weight": Стандартна порція або вага упаковки в грамах (ціле число, наприклад: 100, 200, 400)
